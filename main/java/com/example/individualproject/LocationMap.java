...
import com.example.individualproject.databinding.ActivityLocationMapBinding;
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LocationMap.this, "Unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
